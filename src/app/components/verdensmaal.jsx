    ...
    return (
        <section className='py-(--content-padding) bg-[url(/jordfarvet-bg.png)] bg-cover bg-center'>
                ...
                <div className=" w-(--content-size) m-auto">
                    <div className='glass-card [&_div]:gap-8 md:[&_div]:flex [&_img]:w-[150px] md:[&_img]:w-[200px] [&_img]:object-contain [&_img]:h-auto [&_img]:rounded-lg font-medium text-sm md:text-xl grid gap-8 first:p-8'>
                        <div>
