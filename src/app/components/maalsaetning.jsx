    ...
    return (
        ...
        <section className="
                ...
                <div className="relative z-2 md:w-(--content-size) m-auto">
                    ...
                    <div className="grid md:grid-cols-2 md:border-black md:border-b [&_h1]:font-bold [&_h1]:mb-4 [&_h1]:text-xl md:[&_h1]:text-3xl [&_p]:font-medium [&_p]:text-lg [&_div]:p-4 md:[&_div]:p-8 text-center w-full h-fit">
